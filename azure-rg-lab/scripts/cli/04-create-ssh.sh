#!/usr/bin/env bash
# =============================================================================
# Script: 04-create-ssh.sh
# Purpose: Create or register the SSH key pair used by the VM.
# Pre-req: Source 01-setup-variables.sh first; RG_DEV must exist.
# Usage:   bash ./scripts/cli/04-create-ssh.sh
# =============================================================================
...
echo ""
echo "✅ SSH key ready."
echo "   Azure SSH key name: $SSH_KEY_NAME"
